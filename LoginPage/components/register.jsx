...
export const errorMessages = {
    ...
    password: "En az 8 karakter, büyük/küçük harf ve bir sembol/rakam olarak giriniz!",
};
...
<Form onSubmit={handleSubmit}> 
  <FormGroup>
    ...
    <Input
      ...
      data-cy="ad-input"
    />
    {errors.ad &&<FormFeedback data-cy="ad-message">{errorMessages.ad}</FormFeedback>}
  </FormGroup>
  <FormGroup>
  ...
  <FormGroup>
    ...
    <Input
      id="email"
      name="email"
      placeholder="Kurumsal E-Posta Adresinizi Giriniz!" 
      type="email"
      onChange = {handleChange}
